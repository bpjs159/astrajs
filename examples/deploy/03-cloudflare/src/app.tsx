/**
 * Deploy 03 — Cloudflare · App component
 */
...
export const DeployApp = component(() => {
  const state = store({ output: 'Click a button → the handler runs on the edge.' });
  ...
  return (
    <div class="card">
      <style>{style}</style>
      <h1>Cloudflare Adapter</h1>
      <p class="sub">One Worker for every RPC endpoint. Assets served by Pages.</p>
      <div class="row">
