...
◇ Project name: my-app
◇ Select a template:
   1. minimal    — Just the essentials — astrajs.dev/core + astrajs.dev/compiler
...
Happy building!`} />
        ...
        <table>
          ...
          <tr>
            ...
            <td><code>astrajs.dev/core</code> + <code>astrajs.dev/compiler</code></td>
            <td>{i18n.t('cl.cell.minimal')}</td>
          </tr>
          <tr>
            <td><strong>frontend</strong></td>
            <td>+ <code>astrajs.dev/router</code>, <code>astrajs.dev/form</code>, <code>astrajs.dev/schema</code>, <code>astrajs.dev/validation</code></td>
            <td>{i18n.t('cl.cell.frontend')}</td>
          </tr>
          <tr>
            <td><strong>fullstack</strong></td>
            <td>+ <code>astrajs.dev/server</code>, <code>astrajs.dev/ssr</code></td>
...
├── package.json        → astrajs.dev/* deps + dev/build scripts
├── tsconfig.json       → jsx: react-jsx, jsxImportSource: astrajs.dev/core
...
└── src/
    ...
    └── server/
        ...
        <p>{i18n.t('cl.mono.a')}<code>packages/</code>{i18n.t('cl.mono.b')}<code>astrajs.dev/*</code>{i18n.t('cl.mono.c')}</p>
