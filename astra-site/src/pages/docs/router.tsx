  ...
  <div class="docs-layout">
    ...
    <main class="docs-main">
      <div class="docs-content">
        ...
        <CodeBlock code={`import { route, fallbackRoute } from 'astrajs.dev/router';
...
route('/products/:id', { exact: true })  // only "/products/42"`} commentsKey="router.exact" />
        ...
        <CodeBlock code={`import { route, params } from 'astrajs.dev/router';
...
function ProductPage() {
  ...
  return <h1>Product: {product.data?.name}</h1>;
        ...
        <CodeBlock code={`import { Link } from 'astrajs.dev/router';
...
<Link href="/dashboard">
  ...
  Dashboard
        ...
        <CodeBlock code={`import { navigate } from 'astrajs.dev/router';
...
<button onClick={() => navigate('/docs#instalacion')}>
  View installation
        ...
        <CodeBlock code={`import { Outlet } from 'astrajs.dev/router';
...
::view-transition-new(root) {
  animation: fade-in .3s ease;
        ...
        <CodeBlock code={`import { onRouteChange } from 'astrajs.dev/router';
