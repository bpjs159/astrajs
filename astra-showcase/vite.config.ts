...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@bpjs159/form': path.resolve(__dirname, '../packages/form/src'),
      '@bpjs159/schema': path.resolve(__dirname, '../packages/schema/src'),
      '@bpjs159/validation': path.resolve(__dirname, '../packages/validation/src'),
