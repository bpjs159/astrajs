...
style.textContent = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .brand-mark{display:inline-flex;align-items:center;justify-content:center;width:30px;height:30px;border-radius:9px;background:linear-gradient(135deg,#ff6b9d,#ffa94d);color:#fff;font-size:.9rem;box-shadow:0 0 18px rgba(255,107,157,.35)}
  ...
  .hero-badge{display:inline-block;padding:6px 16px;border-radius:20px;background:rgba(255,107,157,.1);border:1px solid rgba(255,107,157,.25);color:#ffb1cc;font-size:.75rem;font-weight:600;margin-bottom:22px}
  .hero-title{font-size:3rem;font-weight:800;color:#f7f7ff;letter-spacing:-.03em;line-height:1.1;margin-bottom:18px}
  .hero-accent{background:linear-gradient(135deg,#ff6b9d 0%,#ffa94d 60%,#4ade80 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
  ...
  .btn-primary{background:linear-gradient(135deg,#ff6b9d,#ffa94d);color:#fff;box-shadow:0 4px 24px rgba(255,107,157,.3)}
  .btn-primary:hover{transform:translateY(-1px);box-shadow:0 8px 32px rgba(255,107,157,.4)}
  ...
  .section-link{font-size:.85rem;color:#ff6b9d;font-weight:600}
  ...
  .post-card:hover{transform:translateY(-3px);border-color:rgba(255,107,157,.35);box-shadow:0 12px 40px rgba(255,107,157,.12)}
  .post-card-top{display:flex;align-items:center;justify-content:space-between}
  .post-card-category{font-size:.75rem;font-weight:700;color:#ffb1cc}
  ...
  .tag-chip{display:inline-flex;align-items:center;gap:5px;padding:3px 10px;border-radius:20px;background:rgba(255,107,157,.08);border:1px solid rgba(255,107,157,.18);color:#ffb1cc;font-size:.72rem;font-weight:600}
  .tag-link:hover{background:rgba(255,107,157,.16)}
  .tag-more{color:#64748b}
  .tag-count{color:#ff9db8;font-size:.68rem}
  ...
  .recent-item:hover .recent-title{color:#ffb1cc}
  ...
  .category-item:hover{border-color:rgba(255,107,157,.3);transform:translateX(3px)}
  ...
  .category-count{font-size:.8rem;font-weight:800;color:#ff6b9d}
  ...
  .author-mini:hover{transform:translateY(-3px);border-color:rgba(255,107,157,.3)}
  .author-avatar{display:inline-flex;align-items:center;justify-content:center;width:46px;height:46px;border-radius:50%;background:rgba(255,107,157,.12);border:1px solid rgba(255,107,157,.25);font-size:1.4rem}
  ...
  .author-mini-count{font-size:.72rem;color:#ffb1cc;font-weight:600}

  /* ── CTA ── */
  .cta{text-align:center;background:linear-gradient(135deg,rgba(255,107,157,.08),rgba(255,169,77,.08));border:1px solid rgba(255,107,157,.2);border-radius:20px;padding:52px 32px}
  ...
  .footer-link:hover{color:#ffb1cc}
  ...
  .contact-value{font-size:.9rem;color:#ffb1cc;line-height:1.6}
  ...
  .contact-social:hover{border-color:rgba(255,107,157,.35)}
  .contact-handle{font-size:.78rem;color:#64748b;font-weight:500}
  .note-banner{max-width:760px;margin:0 auto;padding:18px 22px;background:rgba(255,107,157,.07);border-left:3px solid rgba(255,107,157,.4);border-radius:0 12px 12px 0;font-size:.86rem;color:#ffb1cc;line-height:1.7}
  ...
  .search-input:focus{border-color:rgba(255,107,157,.5);box-shadow:0 0 0 3px rgba(255,107,157,.12)}
  ...
  .cat-filter.active{background:rgba(255,107,157,.14);border-color:rgba(255,107,157,.5);color:#ffb1cc}
  ...
  .post-category{font-weight:700;color:#ffb1cc}
  ...
  .prose-quote{border-left:3px solid rgba(255,107,157,.5);background:rgba(255,107,157,.05);padding:18px 24px;border-radius:0 12px 12px 0;font-size:1.05rem;font-style:italic;color:#ffb1cc;margin:30px 0}
  ...
  .taxonomy-count{font-size:.82rem;color:#ffb1cc;font-weight:600}
  ...
  .author-role{font-size:.9rem;font-weight:700;color:#ffb1cc}
  ...
  .author-socials a:hover{color:#ffb1cc;border-color:rgba(255,107,157,.35)}
  ...
  .specialty-chip{padding:7px 16px;border-radius:20px;background:rgba(255,107,157,.08);border:1px solid rgba(255,107,157,.2);color:#ffb1cc;font-size:.8rem;font-weight:600}
  ...
  .notfound-block code{background:rgba(255,107,157,.1);color:#ffb1cc;padding:2px 8px;border-radius:5px;font-size:.82rem}
