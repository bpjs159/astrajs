...
style.textContent = `
  /* ── Reset & base (astrajs.dev design system) ── */
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .nav-link.docs-link{color:#c4a0ff;background:rgba(139,77,255,.1);border:1px solid rgba(139,77,255,.35);box-shadow:0 0 12px rgba(139,77,255,.25);border-radius:999px;white-space:nowrap}
  .nav-link.docs-link:hover{background:rgba(139,77,255,.2);border-color:rgba(139,77,255,.6)}

  /* ── Hero (home) ── */
  .hero{max-width:1080px;margin:0 auto;padding:88px 28px 64px;text-align:center}
  .hero-badge{display:inline-block;padding:6px 16px;border-radius:20px;background:rgba(139,77,255,.1);border:1px solid rgba(139,77,255,.35);color:#c4a0ff;font-size:.75rem;font-weight:600;margin-bottom:22px;box-shadow:0 0 12px rgba(139,77,255,.25)}
  .hero-title{font-size:3rem;font-weight:800;color:#f7f7ff;letter-spacing:-.03em;line-height:1.1;margin-bottom:18px}
  .hero-accent{background:linear-gradient(135deg,#b84cff 0%,#4d7cff 50%,#00dfff 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
  ...
  .btn-primary{background:linear-gradient(135deg,#8d4dff,#4d7cff);color:#fff;box-shadow:0 4px 24px rgba(139,77,255,.3)}
  .btn-primary:hover{transform:translateY(-1px);box-shadow:0 8px 32px rgba(139,77,255,.4)}
  ...
  .section-link{font-size:.85rem;color:#c4a0ff;font-weight:600}
  ...
  .post-card:hover{transform:translateY(-3px);border-color:rgba(139,77,255,.4);box-shadow:0 12px 40px rgba(139,77,255,.12)}
  ...
  .tag-chip{display:inline-flex;align-items:center;gap:5px;padding:3px 10px;border-radius:20px;background:rgba(139,77,255,.08);border:1px solid rgba(139,77,255,.25);color:#c4a0ff;font-size:.72rem;font-weight:600}
  .tag-link:hover{background:rgba(139,77,255,.16)}
  .tag-more{color:#64748b}
  .tag-count{color:#b9a5ff;font-size:.68rem}
  ...
  .category-item:hover{border-color:rgba(139,77,255,.4);transform:translateX(3px)}
  ...
  .category-count{font-size:.8rem;font-weight:800;color:#b9a5ff}
  ...
  .author-mini:hover{transform:translateY(-3px);border-color:rgba(139,77,255,.4)}
  .author-avatar{display:inline-flex;align-items:center;justify-content:center;width:46px;height:46px;border-radius:50%;background:rgba(139,77,255,.12);border:1px solid rgba(139,77,255,.35);font-size:1.4rem}
  ...
  /* ── CTA ── */
  .cta{text-align:center;background:linear-gradient(135deg,rgba(139,77,255,.08),rgba(77,124,255,.08));border:1px solid rgba(139,77,255,.25);border-radius:20px;padding:52px 32px}
  ...
  .contact-social:hover{border-color:rgba(139,77,255,.4)}
  .contact-handle{font-size:.78rem;color:#64748b;font-weight:500}
  .note-banner{max-width:760px;margin:0 auto;padding:18px 22px;background:rgba(139,77,255,.07);border-left:3px solid rgba(139,77,255,.5);border-radius:0 12px 12px 0;font-size:.86rem;color:#c4a0ff;line-height:1.7}
  ...
  .search-input:focus{border-color:rgba(139,77,255,.5);box-shadow:0 0 0 3px rgba(139,77,255,.12)}
  ...
  .cat-filter.active{background:rgba(139,77,255,.14);border-color:rgba(139,77,255,.5);color:#c4a0ff}
  ...
  .prose-quote{border-left:3px solid rgba(139,77,255,.5);background:rgba(139,77,255,.05);padding:18px 24px;border-radius:0 12px 12px 0;font-size:1.05rem;font-style:italic;color:#c4a0ff;margin:30px 0}
  ...
  .post-header-contextual .contextual-badge{display:inline-flex;align-items:center;gap:8px;padding:6px 14px;border-radius:8px;background:rgba(0,223,255,.08);border:1px solid rgba(0,223,255,.25);color:#7fd8e8;font-size:.76rem;font-weight:700;font-family:'JetBrains Mono',monospace;margin-bottom:16px}
  ...
  .author-socials a:hover{color:#c4a0ff;border-color:rgba(139,77,255,.4)}
  ...
  .specialty-chip{padding:7px 16px;border-radius:20px;background:rgba(139,77,255,.08);border:1px solid rgba(139,77,255,.25);color:#c4a0ff;font-size:.8rem;font-weight:600}
