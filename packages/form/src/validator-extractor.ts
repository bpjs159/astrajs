/**
 * astrajs.dev/form — Validator Extractor
 *
 ...
 *
 * **Auto-resolution**: Standard astrajs.dev/validation validators are resolved
...
export async function runValidators(
  ...
  for (const meta of validators) {
    ...
    // 3. Built-in registry (astrajs.dev/validation standard validators)
